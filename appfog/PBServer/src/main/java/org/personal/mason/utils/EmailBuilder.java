...
public static String buildEmailBody(String email, String name) {
		...
		builder.append("</h3></br><div><span>Welcome to PBM, and wishing you a happy travelling here!</span></div><div><span>Best Regard!</span></div><div><span><label>Master @ PBM</label></span></div></body></html>");return builder.toString();
	}
}
