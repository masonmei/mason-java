...
<body id="framebody">
	<f:form id="registerForm" action="register" method="post"
		...
		<fieldset>
			...
			<p>
				<label>Retype Password* <f:errors path="passwordConfirm"
						cssClass="error" /></label>
				<f:password path="passwordConfirm" class="inputField"
					alt="enter password again" />
			</p>
			<p>
